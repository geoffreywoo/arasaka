const translations = {
  en: {
    ...
    products: {
      ...
      matrixText: "A procurement-grade scan of every public product and service: owner code, risk domain, deployment surface, proof artifact, and internal dossier route.",
  ...
  ja: {
    ...
    products: {
      ...
      matrixText: "公開製品とサービスを、所有コード、リスク領域、配備面、証明アーティファクト、内部ドシエ経路で調達向けに走査します。",
      matrixOffering: "提供",
      matrixDomain: "領域",
      matrixSurface: "面",
      matrixProof: "証明",
